...
If you use a different payment processor than GitHub Sponsors, [help us document the activation steps here](https://github.com/ossmaintenancefee/www/src/content/docs/maintainers/setup.mdx).
</Aside>
...
<Aside type='tip' title='Maintainers'>
Is your ecosystem missing from these examples? [Help us out by adding an example](https://github.com/ossmaintenancefee/www/src/content/docs/maintainers/setup.mdx).
</Aside>
